        ...
        if(type==="theory"){
            return (canvas) => {
                ...
                theorydata.forEach(test => {
                    x_axis.push(new Date(test.created_at).toLocaleString(undefined,options));
            ...
            return canvas => {
                ...
                objectivedata.forEach(test => {
                    x_axis2.push(new Date(test.created_at).toLocaleString(undefined,options));
