...
const Viewtresult = ({match, slug}) => {
    ...
    const updateresults = () => {
        ...
        UserService
            .gettestresults(match.params.test)
            .then(response => {
    ...
    const exceldata = (dresult)=>{
        ...
        for (var i = 0; i<dresult.length; i++){
            ...
            obj.score = result.score+"/"+test.total +' '+(Math.round(result.score/test.total*100))+"%";
            data.push(obj);
        }
        return data;
    }
                                ...
                                <Col md="12">
                                                                    ...
                                                                    .map((result, key) => {
                                                                        return (
                                                                            <tr key={result.id}>
                                                                                ...
                                                                                <td>{result.score+"/"+test.total} ({Math.round(result.score/test.total*100)})%</td>
                                                                            </tr>
                                                                        )
                                                                    })}
                                                            </tbody>
                                    ...
                                    {noresults
                                        ? <div>
                                                ...
                                                Mark Students' Submissions to see results.</div>
                                        : ''}
                                </Col>
