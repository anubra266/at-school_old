            ...
            <CardBody className="all-icons">
                ...
                <TabContent activeTab={activeTab}>
                    <TabPane tabId="1">
                        <Row>
                            {theoryTests
                                ? theoryTests.slice(currentTheoryPage * pageSize, (currentTheoryPage + 1) * pageSize).map((test) => {
                                    return (
                                        <Col md="4">
                                            <Card body>
                                                <CardTitle>
                            ...
                            {notheory
                                ? <Col md="12">
                                        <div>
                                            ...
                                            Create one and Check again.</div>
                                    </Col>
                                : ''}
                        </Row>
                    ...
                    <TabPane tabId="2">
                        <Row>
                            {objectiveTests
                                ? objectiveTests.slice(currentObjectivePage * pageSize, (currentObjectivePage + 1) * pageSize).map((test) => {
                                    return (
                                        <Col md="4">
                                            <Card body>
                                                <CardTitle>
